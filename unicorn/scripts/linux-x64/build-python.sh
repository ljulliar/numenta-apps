...
BUILD_CMD="cmake $NUPIC_CORE -DCMAKE_INCLUDE_PATH=${PREFIX}/include \
-DCMAKE_LIBRARY_PATH=${PREFIX}/lib -DCMAKE_PREFIX_PATH=${PREFIX} \
-DCMAKE_INSTALL_PREFIX=${PREFIX} -DPY_EXTENSIONS_DIR=${NUPIC_CORE}/bindings/py/nupic/bindings \
-DPYTHON_EXECUTABLE:FILEPATH=${PREFIX}/bin/python2.7 \
-DPYTHON_INCLUDE_DIR:PATH=${PREFIX}/include/python2.7 \
-DPYTHON_LIBRARY:FILEPATH=${PREFIX}/lib/libpython2.7.so"
$BUILD_CMD
